...
export default function ActionCard() {
  function openWebUrl(webUrl: any) {
    Linking.openURL(webUrl);
  }
  return (
    <TouchableOpacity
      onPress={() =>
        openWebUrl('https://colorhunt.co/palette/f9efdbebd9b49dbc98638889')
      }>
      <View style={styles.card}>
        ...
        <View style={styles.content}>
          ...
          <Text style={[styles.text, styles.desc]}>
            ...
            Praesentium, fugit esse accusantium ut consequuntur cupiditate ab
            molestias iste perferendis deserunt?
          </Text>
        </View>
      </View>
    </TouchableOpacity>
